        ...
        return (
            <Fragment>
                <a
                    ...
                    href={`https://facebook.com/sharer/sharer.php?u=http%3A%2F%2Fmk100.in%2Ffeed%2F${this.props.parentFeedId}`}
                    target="_blank"
                ...
                <a
                    className="resp-sharing-button__link"
                    href={`https://twitter.com/intent/tweet/?text=http%3A%2F%2Fmk100.in%2Ffeed%2F${this.props.parentFeedId}`}
                    target="_blank"
                ...
                <a
                    className="resp-sharing-button__link"
                    href={`whatsapp://send?text= http%3A%2F%2Fmk100.in%2Ffeed%2F${this.props.parentFeedId}`}
                    target="_blank"
                ...
                <Link
                    ...
                    to={{
                        pathname: '/chat',
                        state: {message: `http://mk100.in/feed/${this.props.parentFeedId}`}
                    }}
                >
